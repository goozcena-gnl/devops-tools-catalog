...
| Lifecycle stages | **12** |
| Records not flagged for review | **606** |
| Records requiring review | **817** |
| Deprecated, archived, or historical records | **14** |
| Archived source repositories | **11** |
| Most recent recorded verification date | **2026-09-17** |
...
|---|---|---:|
| `oss` | Source claims an OSI-approved licence; verify SPDX before adoption. | 926 |
...
| `commercial` | Proprietary commercial product. | 141 |
| `free-saas` | Hosted service with a free offering. | 5 |
| `documentation` | Learning or documentation resource. | 108 |
| `unknown` | Reliable licence evidence has not been recorded. | 108 |

## Project-status legend

| Status | Meaning | Records |
|---|---|---:|
| `active` | Maintained according to recorded primary-source evidence. | 593 |
| `needs-review` | Imported but not yet fully verified. | 816 |
