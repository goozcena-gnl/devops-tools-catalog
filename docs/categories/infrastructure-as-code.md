...
37 canonical records reference this category.
...
[Official site](https://aws.amazon.com/cdk) · [Documentation](https://docs.aws.amazon.com/cdk/) · [Source repository](https://github.com/aws/aws-cdk)
...
[Official site](https://aws.amazon.com/cloudformation) · [Documentation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html) · [Source repository](https://github.com/aws-cloudformation/aws-cloudformation-templates)
...
- Your platform team chooses C# for Crossplane composition logic and can maintain the function service and generated models.

**Consider alternatives when**

- You can use an existing composition function or do not support the documented Crossplane version.
...
**Categories:** Infrastructure as Code<br>
**Roles:** Cloud Engineer, DevOps Engineer, Platform Engineer, Infrastructure and Systems Engineer<br>
**Model:** Open Core<br>
**Status:** Active

Network source-of-truth and automation platform with extensible data models and application plugins.

**Use when**

- You need a programmable network source of truth that drives validation and automation workflows.

**Consider alternatives when**

- Avoid it when a simple IPAM or static inventory meets requirements without an application platform.

[Official site](https://docs.nautobot.com/) · [Documentation](https://docs.nautobot.com/projects/core/en/stable/) · [Source repository](https://github.com/nautobot/nautobot)
...
**Categories:** Infrastructure as Code<br>
**Roles:** Platform Engineer, Cloud Engineer<br>
**Model:** Oss<br>
**Status:** Active

Code generation and controller runtime for building Crossplane providers from Terraform providers.

**Use when**

- You maintain a Crossplane provider and want to reuse a Terraform provider's resource schema and implementation.

**Consider alternatives when**

- You only consume an existing provider or cannot maintain generated controllers and Terraform compatibility.

[Documentation](https://github.com/crossplane/upjet/blob/main/README.md) · [Source repository](https://github.com/crossplane/upjet)
