...
794 records support this lifecycle stage.
...
- [Antrea](https://antrea.io/) — Kubernetes CNI and network-policy implementation built on Open vSwitch.
...
- [Apache Cassandra](https://cassandra.apache.org/) — Distributed wide-column database designed for replicated, horizontally scalable workloads.
...
- [Apache HBase](https://hbase.apache.org/) — Distributed wide-column datastore integrated with the Hadoop ecosystem.
- [Apache HTTP Server](https://httpd.apache.org/) — Modular HTTP server supporting web hosting, TLS, authentication, and reverse proxying.
...
- [bottom](https://bottom.pages.dev/stable/) — Terminal resource monitor for processes, CPU, memory, and disks.
...
- [Chef Infra](https://www.chef.io/products/chef-infra) — Commercially distributed infrastructure configuration-management tooling with separately Apache-licensed upstream source.
...
- [GoAccess](https://goaccess.io/) — Terminal and HTML web-log analyser providing real-time HTTP traffic statistics.
...
- [k (rothgar)](https://github.com/rothgar/k) — Experimental kubectl wrapper adding context, cluster, and namespace shorthand.
...
- [kubectl-x](https://github.com/platformersdev/kubectl-x) — Read-only kubectl plugin for querying and streaming logs across multiple kubeconfig contexts.
...
- [KubeVirtBMC](https://docs.kubevirtbmc.io/) — IPMI and Redfish management interfaces for KubeVirt virtual machines.
...
- [Linux kernel](https://www.kernel.org/) — Operating-system kernel underpinning Linux server, cloud, and container hosts.
...
- [OIDC-Guard](https://github.com/IvanJosipovic/OIDC-Guard) — External-authentication API service for JWT and cookie validation at Kubernetes ingress.
...
- [ouch](https://github.com/ouch-org/ouch) — Command-line archive compression and extraction tool with format detection.
...
- [Rackula](https://www.racku.la/) — Browser-based rack layout designer for planning equipment placement and exporting rack diagrams.
...
- [Syncthing](https://syncthing.net/) — Continuous peer-to-peer file synchronization service with encrypted transport and no mandatory central server.
...
- [Tinkerbell](https://tinkerbell.org/) — Bare-metal provisioning stack for declarative machine installation workflows.
...
- [Traefik Proxy](https://traefik.io/traefik) — Reverse proxy and ingress controller with dynamic service discovery.
...
- [WSO2 API Platform](https://wso2.com/api-platform/) — API lifecycle platform with gateway, governance, and developer-portal capabilities across deployment models.
...
- [youki](https://youki-dev.github.io/youki/) — OCI container runtime implemented in Rust.
