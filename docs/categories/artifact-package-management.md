...
Package repository manager for governing APT, RPM, and APK artifacts with security metadata and audit trails.

**Use when**

- You need a self-hosted Linux package repository with signing, scanning, SBOM, and approval workflows.

**Consider alternatives when**

- Avoid production adoption until the project's licence and sustained maintenance history are verified.

[Official site](https://getrepod.com/) · [Documentation](https://docs.getrepod.com/) · [Source repository](https://github.com/getautoflow/repod)
