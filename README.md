...
| Lifecycle stages | **12** |
| Records not flagged for review | **611** |
| Records requiring review | **812** |
...
|---|---|---:|
| `oss` | Source claims an OSI-approved licence; verify SPDX before adoption. | 931 |
...
| `unknown` | Reliable licence evidence has not been recorded. | 103 |

## Project-status legend

| Status | Meaning | Records |
|---|---|---:|
| `active` | Maintained according to recorded primary-source evidence. | 598 |
| `needs-review` | Imported but not yet fully verified. | 811 |
