...
CLI benchmark runner for repeated command timing and statistical comparison.

**Use when**

- You compare operational commands or build steps and can control warmup, caches, and environment noise.

**Consider alternatives when**

- You need distributed load generation or detailed application profiling rather than elapsed-command measurements.

[Documentation](https://github.com/sharkdp/hyperfine/blob/master/README.md) · [Source repository](https://github.com/sharkdp/hyperfine)
...
HTTP load-generation CLI with an interactive results display.

**Use when**

- You run controlled endpoint load tests and can choose suitable concurrency and rate limits.

**Consider alternatives when**

- You need browser-level workflows or coordinated distributed load generation.

[Documentation](https://github.com/hatoo/oha/blob/master/README.md) · [Source repository](https://github.com/hatoo/oha)
